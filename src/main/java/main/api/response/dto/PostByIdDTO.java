...
public class PostByIdDTO {
    ...
    public PostByIdDTO(int id, long timestamp, boolean active, UserInPostDTO user, String title, String text, int likeCount, int dislikeCount, int viewCount, List<CommentDTO> comments, Set<String> tags) {
        this.id = id;
